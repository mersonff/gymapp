...
RSpec.describe RemoteLinkPaginationHelper, type: :helper do
  describe RemoteLinkPaginationHelper::LinkRenderer do
    let(:renderer) { RemoteLinkPaginationHelper::LinkRenderer.new }
    ...
    describe 'inheritance' do
      it 'inherits from WillPaginate::ActionView::LinkRenderer' do
        expect(RemoteLinkPaginationHelper::LinkRenderer).to be < WillPaginate::ActionView::LinkRenderer
      end
    end

    describe 'module structure' do
      it 'defines LinkRenderer class inside the module' do
        expect(RemoteLinkPaginationHelper::LinkRenderer).to be_a(Class)
      end
    end
  end
end