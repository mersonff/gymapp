...
RSpec.describe "Turbo Stream Interactions", type: :system do
  ...
  describe "Adding measurements via Turbo Stream" do
    it "adds new measurement without page reload", :skip do
      ...
      # Form should appear
      expect(page).to have_selector("#measurement_form")
      ...
      expect(page).not_to have_selector("#measurement_form")
  ...
  describe "Adding payments via Turbo Stream" do
    it "adds new payment without page reload", :skip do
      ...
      expect(page).to have_selector("#payment_form")
      ...
      expect(page).not_to have_selector("#payment_form")
  ...
  describe "Adding skinfolds via Turbo Stream" do
    it "adds new skinfold measurement without page reload", :skip do
      ...
      expect(page).to have_selector("#skinfold_form")
      ...
      expect(page).not_to have_selector("#skinfold_form")
