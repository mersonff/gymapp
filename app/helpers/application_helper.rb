module ApplicationHelper
  ...
  def flash_icon(type)
    ...
    when 'danger', 'error'
      content_tag :svg, class: "w-5 h-5 text-red-400", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" do
        content_tag :path, nil, "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", d: "M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"
      end
    when 'warning'
      content_tag :svg, class: "w-5 h-5 text-yellow-400", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" do
        content_tag :path, nil, "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", d: "M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L4.082 16.5c-.77.833.192 2.5 1.732 2.5z"
      end
    else
  ...
  def turbo_frame_tag(id, **options, &block)
    options[:id] = id
    content_tag("turbo-frame", options, &block)
  end
end
